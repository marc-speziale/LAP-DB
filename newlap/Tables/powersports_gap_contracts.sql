CREATE TABLE [newlap].[powersports_gap_contracts] (
    [id]                         BIGINT         IDENTITY (96, 1) NOT NULL,
    ...
    CONSTRAINT [PK_powersports_gap_contracts_id] PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [powersports_gap_contracts$account_admin_powersports_gap_contracts] FOREIGN KEY ([account_admin_id]) REFERENCES [newlap].[account_admins] ([id]),
    CONSTRAINT [powersports_gap_contracts$powersports_gap_contracts_dealership_id_foreign] FOREIGN KEY ([dealership_id]) REFERENCES [newlap].[dealerships] ([id])
);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_first_name_index]
    ON [newlap].[powersports_gap_contracts]([first_name] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_dealership_id_foreign]
    ON [newlap].[powersports_gap_contracts]([dealership_id] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_last_name_index]
    ON [newlap].[powersports_gap_contracts]([last_name] ASC);


GO

CREATE NONCLUSTERED INDEX [account_admin_powersports_gap_contracts]
    ON [newlap].[powersports_gap_contracts]([account_admin_id] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_interest_rate_index]
    ON [newlap].[powersports_gap_contracts]([interest_rate] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_product_type_index]
    ON [newlap].[powersports_gap_contracts]([product_type] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_completed_at_index]
    ON [newlap].[powersports_gap_contracts]([completed_at] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_created_at_index]
    ON [newlap].[powersports_gap_contracts]([created_at] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_vin_index]
    ON [newlap].[powersports_gap_contracts]([vin] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_contract_number_index]
    ON [newlap].[powersports_gap_contracts]([contract_number] ASC);


GO

CREATE NONCLUSTERED INDEX [powersports_gap_contracts_status_index]
    ON [newlap].[powersports_gap_contracts]([status] ASC);


GO

EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'newlap.powersports_gap_contracts', @level0type = N'SCHEMA', @level0name = N'newlap', @level1type = N'TABLE', @level1name = N'powersports_gap_contracts';
